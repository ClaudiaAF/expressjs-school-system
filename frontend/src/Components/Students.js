...
import Table from './LynnBrock';


class IanReid extends React.Component {
    state = {
        isLoading: true,
        learners: [],
        error: null,
    ...
    fetchlearners() {
        fetch(`http://localhost:8000/api/classes/learners/1`)
